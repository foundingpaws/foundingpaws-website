    ...
    >
      <div className="relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden h-full flex flex-col">
        ...
        <div className="p-6 flex-1 flex flex-col">
          ...
          {/* Title & Subtitle */}
          <div className="mt-4">
            <h3 className="text-xl font-bold text-gray-900 mb-1 group-hover:text-accent transition-colors duration-300">
              {product.title}
            </h3>
          ...
          <div className="mt-6">
            <Link
              ...
              className={`block w-full text-center px-6 py-3 rounded-full font-medium transition-all duration-300 relative overflow-hidden ${
                isHovered
