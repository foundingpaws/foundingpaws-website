          ...
          <FadeIn>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="use-fredoka text-lg sm:text-xl text-cream/90 max-w-3xl mx-auto leading-relaxed mb-8">
                Unterstütze die kognitive Funktion und Herzgesundheit deines Hundes mit wissenschaftlich entwickelten Formeln.
              </p>
            ...
            <FadeIn>
              <div>
                <h2 className="use-retrips text-3xl sm:text-4xl text-green mb-6">
                  Wenn dein Hund Unterstützung braucht
                </h2>
                <div className="space-y-4 text-green/75">
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-copper text-lg">•</span>
                    <span>Weniger Interesse an Aktivitäten oder Spielen</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-copper text-lg">•</span>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-copper text-lg">•</span>
                    <span>Müdigkeit oder verminderte Vitalität</span>
                  </div>
                </div>
              </div>
            </FadeIn>
            <FadeIn delay={0.1}>
              <div className="bg-white/70 backdrop-blur-sm border border-taupe/20 rounded-[28px] p-8 shadow-[0_16px_48px_-16px_rgba(142,127,116,0.25)]">
                ...
                <p className="text-green/75 leading-relaxed mb-6">
                  <strong className="text-copper">Bright Mind</strong> kombiniert bewährte Nährstoffe für kognitive Funktion und Herzgesundheit. 
                  Wissenschaftlich entwickelt, handgefertigt in Heilbronn.
                </p>
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-2">
                    <span className="text-copper">✓</span>
                    <span>Fördert geistige Klarheit</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-copper">✓</span>
                    <span>Unterstützt Herzfunktion</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-copper">✓</span>
          ...
          <FadeIn>
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="use-fredoka text-lg text-green/70 mb-8">
                Die perfekte Formel für kognitive Unterstützung und Herzgesundheit
              </p>
            </div>
          </FadeIn>
          ...
          <div className="max-w-2xl mx-auto">
            <FadeIn delay={0.1}>
              <div className="bg-white/70 backdrop-blur-sm border border-taupe/20 rounded-[28px] p-8 sm:p-12 text-center shadow-[0_20px_60px_-20px_rgba(180,106,52,0.3)]">
                ...
                <p className="use-fredoka text-lg text-copper mb-6">Kognitive Unterstützung & Herzgesundheit</p>
                <p className="text-green/70 leading-relaxed mb-8">
                  Fördert geistige Klarheit und unterstützt die Herzfunktion – für ein waches, vitales Hundeleben.
                </p>
