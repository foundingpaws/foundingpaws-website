...
export default function ImmunsystemPage() {
  return (
              ...
              <div>
                ...
                <div className="space-y-4 text-green/75">
                  <div className="flex items-start gap-3">
                    ...
                    <span>Häufige Infekte oder Erkältungen</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-copper text-lg">•</span>
                    <span>Langsame Erholung nach Krankheit</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-copper text-lg">•</span>
                    <span>Schwäche in Stressphasen</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-copper text-lg">•</span>
                    <span>Fellwechsel oder Jahreszeitenwechsel</span>
                  </div>
                </div>
              </div>
            </FadeIn>
              ...
              <div className="bg-white/70 backdrop-blur-sm border border-taupe/20 rounded-[28px] p-8 shadow-[0_16px_48px_-16px_rgba(142,127,116,0.25)]">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Stärkt die Abwehrkräfte</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-copper">✓</span>
                    <span>Unterstützt die Regeneration</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-copper">✓</span>
                    <span>Fördert die Widerstandskraft</span>
                  </div>
                </div>
              </div>
            </FadeIn>
